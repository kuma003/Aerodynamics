...
本稿は，両者を中心に，ロケットの空力諸元の導出をまとめるものである．
...
\end{itemize}
OpenRocketでは，特にモデルロケットを想定しているため，落下時のような迎角が大きい場合についても言及されているが，
本稿では，この仮定の下で議論を進める．
...
\begin{equation}
  (C_{N_\alpha})_1 = \frac{C_{N_\alpha0}F_D (\frac{A_\mathrm{fin}}{A_\mathrm{ref}}\cos\Gamma)}{2 + F_D \sqrt{1 + \frac{4}{F_D^2}}}
  \tag{OR.3.37}
\end{equation}
